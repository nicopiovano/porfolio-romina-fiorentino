      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="mb-12">
          ...
          <p className="text-muted-foreground text-lg">
            Conjunto de competencias técnicas y blandas desarrolladas a lo largo
            de mi carrera
          </p>
        </div>
        ...
        <div className="mt-12 bg-muted/50 border border-border rounded-xl p-8">
          <h3 className="mb-4">Idiomas</h3>
          <div className="grid sm:grid-cols-3 gap-6">
            <div>
              <p className="text-foreground mb-1">Español</p>
              <p className="text-muted-foreground text-sm">Nativo</p>
            </div>
            <div>
              <p className="text-foreground mb-1">Inglés</p>
              <p className="text-muted-foreground text-sm">Básico (A2)</p>
            </div>
            {/* <div>
